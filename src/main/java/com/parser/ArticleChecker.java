...
public class ArticleChecker {
    ...
    public static void checkLatestArticleFromAnotherPage(TelegramBotConfig botConfig){
        botConfig.sendToAll("ℹ️ checkLatestArticleFromAnotherPage");

//        https://ondrl.gov.md/comunicare-publica/ this is next
    }
}
